---
name: mex-inbox
description: Draft and review contributions to MEX project memory in the repo wiki. Use when the user wants to capture a team decision, convention, architecture note, or correction for review, or when they invoke /mex-inbox or $mex-inbox. Also for existing Spec proposals. Keywords: mex, project memory, CLAUDE.md, team memory, drift, inbox. Do not activate for brainstorming alone, routine GROW upkeep, email inboxes, session logs, or handoffs.
---
