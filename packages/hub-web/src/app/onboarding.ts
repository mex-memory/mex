  ...
  return [
    ...
    },
    {
      ...
      features: [
        ...
        { title: "Settings", detail: "Choose when agents write optional project notes, and replay this tour.", icon: Settings2 },
    ...
    },
    {
      ...
      icon: Compass,
      targets: ["overview"],
      description: "Overview is the daily landing, here at the top of the primary nav. Context is the fastest way to see how this repository is connected.",
